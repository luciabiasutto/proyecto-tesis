 ...
 * Expone los endpoints para pedir el enlace por email y poner una contraseña nueva
 */
@RestController
...
public class RecuperacionPasswordController {
    ...
    //Pide el envío del email con el enlace de recuperación 
    ...
    //Cambia la contraseña usando el token que llegó por email
    ...
    /**
     * Comprueba si el token del enlace sigue siendo válido antes de mostrar el formulario.
     * Lo usa el frontend al abrir la página de recuperación; no lo llama el usuario a mano.
     */
