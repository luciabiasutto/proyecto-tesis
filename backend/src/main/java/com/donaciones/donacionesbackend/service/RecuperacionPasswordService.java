            ...
            switch (tokenRecuperacion.getRol().toUpperCase()) {
                case "DONANTE":
                    ...
                    if (donante.isPresent()) {
                        donante.get().setPassword(passwordService.encode(nuevaPassword));
                ...
                case "ADMINISTRADOR":
                    ...
                    if (admin.isPresent()) {
                        admin.get().setPassword(passwordService.encode(nuevaPassword));
                ...
                case "ORGANIZACION":
                    ...
                    if (org.isPresent()) {
                        org.get().setPassword(passwordService.encode(nuevaPassword));
